...
create_clock -period 3.225 [get_ports sys_clk_i]
...
set_property PACKAGE_PIN W2 [get_ports {ddr3_dq[5]}]
...
set_property PACKAGE_PIN W1 [get_ports {ddr3_dq[7]}]
...
set_property PACKAGE_PIN Y6 [get_ports {ddr3_addr[14]}]
...
set_property PACKAGE_PIN V8 [get_ports {ddr3_addr[5]}]
...
set_property PACKAGE_PIN AA6 [get_ports {ddr3_addr[2]}]
